...
namespace PFE_EMI.Controllers
{
    public class EtudiantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Fname,Lname,Email,Branch,ID_specialty")] Etudiant etudiant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Fname,Lname,Email,Branch,ID_specialty")] Etudiant etudiant)
        {
            if (id != etudiant.ID)
            {
                return NotFound();
